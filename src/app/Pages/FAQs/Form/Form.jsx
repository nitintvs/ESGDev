...
const Form = (props) => {
    ...
    const updateFaqInfo = (event) =>{
        ...
        if(props.faqInfoLength && props.faqInfoLength > 0){
            ...
            formData.append('id', props.faqInfo && props.faqInfo.id)
        ...
        <>
            ...
            <Stack spacing={3} mb={'30px'}>
                <Input
                    ...
                    defaultValue={props.faqInfo && props.faqInfo.prop_label}
                />
                <Input type="file" onChange={bannerUpload} padding={"4px"} />
                <Image src={props.faqInfo && props.faqInfo.banner} />
                <JoditEditor
                    id={"description"}
                    ref={editor}
                    value={props.faqInfo && props.faqInfo.description}
                    tabIndex={1} // tabIndex of textarea
                />
                <Button colorScheme='teal' variant='outline' w={100} onClick={updateFaqInfo}>
                    Save
                </Button>
            </Stack>
        </>
