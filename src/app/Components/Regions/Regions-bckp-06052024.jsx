                    ...
                    <Tabs variant='enclosed'>
                        ...
                        <TabPanels>
                            <TabPanel>
                                ...
                                <SimpleGrid columns={[1, 2, 3, 4, 5]} spacing='20px' mt={'10px'}>
                                    {
                                        countryList && countryList.map(country =>
                                            <Box height='80px'>
                                                <Link to={`country/${country.id}/${country.name}`}>
                                                    <Card>
                                                        <CardBody p={'0px'}>
                                                            <Box float={'left'} mr={'5px'} backgroundColor={"#000000"} className={Styles.flagContainer}>
                                                                <ReactCountryFlag countryCode={country.country_code} svg className={Styles.flagImage} />
                                                            </Box>
                                                            <Box float={'left'} w={'68%'} className={Styles.countryName}>
                                                                {country.name}
                                                            </Box>
