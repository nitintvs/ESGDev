...
import NewStyles from './teamlist.module.css'
...
const TeamList = (props) => {
    ...
    return (
        <>
            ...
            <Box className={NewStyles.customBorder}>
                {
                    props.editable ? 
                        ...
                        <CardBody padding={'0'}>
                            <Box className={Styles.clearfix}>
                                <Box float={'left'} maxWidth={'80px'}>
                                    <Image src={props.image ? props.image : userPlaceholder} h={'106.66px'} maxW={'80px'} />
                                </Box>
                                <Box className={NewStyles.floaterBox} float={'left'} p={'5px'}>
                                    <Text className={NewStyles.teamLink +' '+ NewStyles.textFocus}> {props.name} </Text>
                                    <Text py='2' className={NewStyles.textCaption}>{props.jobTitle}</Text>
                                </Box>
                            </Box>
                        </CardBody>
                    </Card>
